                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center btn-group" role="button">
                                                ...
                                                <a data-toggle="modal" data-target="#category-edit" href="{{ route('category.edit', $category->id) }}" id="{{$category->id}}" value="{{$category->name}}" class="btn btn-warning btn-sm editModal"><i class="fas fa-edit"></i></a>
