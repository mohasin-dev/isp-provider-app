                    ...
                    <div class="col-xl-12 col-sm-12 p-2">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Feature's List</h3>
                            </div>
                            <div class="card-body">
                                <table id="myTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $feature->updated_at->format('d M Y') }}</td>
                                            <td class="text-center btn-group" role="button">
                                                {{-- <a href="#" class="btn btn-primary btn-sm"><i class="fas fa-file-alt"></i></a> --}}
                                                <a data-toggle="modal" data-target="#feature-edit" href="{{ route('feature.edit', $feature->id) }}" id="{{$feature->id}}" value="{{$feature->name}}" class="btn btn-warning btn-sm editModal"><i class="fas fa-edit"></i></a>
                                                <button type="button" onclick="deletefeature({{ $feature->id }})" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></button>
                                        ...
                                        <!--modal-->
                                        <div class="modal fade" id="feature-edit">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('feature.update', $feature->id) }}">
                                                            ...
                                                            <div class="form-group md-form">
                                                                ...
                                                                <input type="text" name="name" value="" id="featureName" class="form-control">
                                                            </div>
...
<script>
        ...
        $(".modal-body #editThisID").val(featureId);
        $(".modal-body #featureName").val(featureName);
        });
</script>
