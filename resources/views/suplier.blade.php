...
@section('content')
<br><br>
{{-- <h3 style="border-bottom: 3px solid #999" class="text-center card-common">Supliers</h3> --}}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center btn-group" role="group">
                                                    ...
                                                    <a data-toggle="modal" data-target="#suplier-edit" href="{{ route('suplier.edit', $suplier->id) }}" id="{{ $suplier->id }}" data-name="{{$suplier->name}}" data-email="{{$suplier->email}}" data-phone="{{$suplier->phone}}" data-address="{{$suplier->address}}" data-note="{{$suplier->note}}" class="btn btn-warning btn-sm editModal"><i class="fas fa-edit"></i></a>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="{{ route('suplier.update', $suplier->id) }}">
                                                                ...
                                                                <div class="form-group md-form">
                                                                    ...
                                                                    <input type="text" name="name" id="suplierName" class="form-control">
                                                                </div>
                                                                <div class="form-group md-form">
                                                                    <label for="exampleInputEmail1">suplier Email</label>
                                                                    <input type="text" name="email" id="suplierEmail" class="form-control">
                                                                </div>
                                                                <div class="form-group md-form">
                                                                    <label for="exampleInputEmail1">suplier Phone</label>
                                                                    <input type="text" name="phone" id="suplierPhone" class="form-control">
                                                                </div>
                                                                <div class="form-group md-form">
                                                                    <label for="exampleInputEmail1">suplier Address</label>
                                                                    <input type="text" name="address" id="suplierAddress" class="form-control">
                                                                </div>
...
<script>
      ...
      $(".modal-body #editThisID").val(suplierId);
