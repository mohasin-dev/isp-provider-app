                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center btn-group" role="button">
                                                ...
                                                <a data-toggle="modal" data-target="#unit-edit" href="{{ route('unit.edit', $unit->id) }}" id="{{$unit->id}}" value="{{$unit->name}}" class="btn btn-warning btn-sm editModal"><i class="fas fa-edit"></i></a>
                                                <button type="button" onclick="deleteunit({{ $unit->id }})" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></button>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('unit.update', $unit->id) }}">
                                                            ...
                                                            <div class="form-group md-form">
                                                                ...
                                                                <input type="text" name="name" value="" id="unitName" class="form-control">
                                                            </div>
...
<script>
        ...
        var unitName = $(this).attr('value');
        $(".modal-body #editThisID").val(unitId);
        $(".modal-body #unitName").val(unitName);
        });
</script>
