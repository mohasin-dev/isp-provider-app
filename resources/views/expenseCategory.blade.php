                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center btn-group" role="button">
                                                ...
                                                <a data-toggle="modal" data-target="#category-edit" href="{{ route('expense-category.edit', $category->id) }}" id="{{$category->id}}" value="{{$category->name}}" class="btn btn-warning btn-sm editModal"><i class="fas fa-edit"></i></a>
                                                <button type="button" onclick="deleteCategory({{ $category->id }})" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></button>
                                                <form id="delete-form-{{ $category->id }}" action="{{ route('expense-category.destroy',$category->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('expense-category.update', $category->id) }}">
                                                            ...
                                                            <div class="form-group md-form">
                                                                <label for="exampleInputEmail1">Expense Category Name</label>
                                                                <input type="hidden" name="id" value="" id="editThisID" class="form-control" readonly="">
                                                                <input type="text" name="name" value="" id="categoryName" class="form-control">
                                                            </div>
...
<script>
        ...
        $(".modal-body #editThisID").val(categoryId);
